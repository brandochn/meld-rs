...
mod tests {
    ...
    fn test_detect_inserted_import_line() {
        let left: Vec<String> = vec![
            ...
            "import { IRouteParams } from 'brits-shared';",
            "import { EnvironmentContext, isViewPermissionOnly, getAccountGuid, useSwallowNotification } from 'brits-ui-shared';",
        ...
        let right: Vec<String> = vec![
            ...
            "import { getBusinessObject, is } from 'bpmn-js/lib/util/ModelUtil';",
            "import { IRouteParams } from 'brits-shared';",
            "import { isViewPermissionOnly, notifySuccess, notifyWarning, notifyError, getAccountGuid } from 'brits-ui-shared';",
            "import { EnvironmentContext } from 'brits-ui-shared';",
            "import BpmnModeler from 'camunda-bpmn-js/lib/camunda-cloud/Modeler';",
            "import isEmpty from 'lodash/isEmpty';",
